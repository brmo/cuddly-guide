    ...
    <div class="max-w-2xl">
        <div class="md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
                <h2 class="text-2xl font-bold leading-7 text-gray-900 dark:text-gray-100 sm:text-3xl sm:truncate">New User</h2>
            </div>
        ...
        <form @submit.prevent="submit" class="mt-6 space-y-6 bg-white dark:bg-gray-800 shadow px-4 py-5 sm:p-6 rounded-lg">
            ...
            <div>
                ...
                <p v-if="form.errors.slack_user_id" class="mt-1 text-sm text-red-600">{{ form.errors.slack_user_id }}</p>
            </div>
